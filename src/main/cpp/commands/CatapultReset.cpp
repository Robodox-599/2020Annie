...
bool CatapultReset::IsFinished() { return Robot::catapultSystem.GetLimitSwitch(); }

// Called once after isFinished returns true
void CatapultReset::End() {Robot::catapultSystem.PullBack(0);}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void CatapultReset::Interrupted() {End();}
